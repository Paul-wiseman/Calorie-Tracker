package com.plcoding.onboarding_presentation.screen.gender
...
fun GenderScreen(
    ...
    LaunchedEffect(key1 = true) {
        genderViewModel.uiEvent.collect {
            when (it) {
        ...
        Column(
            ...
            Row {
                SelectableButton(
                    ...
                    onClick = {
                        genderViewModel.onGenderEventClicked(Gender.Male)
                    },
                ...
                SelectableButton(
                    ...
                    selectedTextColor = Color.White,
                    onClick = {
                        genderViewModel.onGenderEventClicked(Gender.Female)
                    },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
